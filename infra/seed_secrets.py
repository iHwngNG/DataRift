...
def main():
    ...
    if not api_key or api_key.startswith("RGAPI-your-api-key"):
        print("Error: RIOT_API_KEY in .env is either empty or a placeholder.", file=sys.stderr)
    ...
    try:
        ...
        print("Please ensure Google Cloud SDK is installed and configured in your PATH.", file=sys.stderr)
        sys.exit(1)
